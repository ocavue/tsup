...
var require_flat = _chunkGQ77QZBOjs.__commonJS.call(void 0, {
...
// src/cli-main.ts
var import_flat = _chunkGQ77QZBOjs.__toESM.call(void 0, require_flat());
...
async function main(options = {}) {
  ...
  cli.command("[...files]", "Bundle files", {
    ...
    if (!options.entry && files.length > 0) {
      options.entry = files.map(_chunkGQ77QZBOjs.slash);
    }
    if (flags.format) {
