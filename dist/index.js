...
var _chunkX22RQBZHjs = require('./chunk-X22RQBZH.js');



var _chunkJ7IVU4KGjs = require('./chunk-J7IVU4KG.js');
...
var _chunkBL2PMODFjs = require('./chunk-BL2PMODF.js');

// node_modules/.pnpm/consola@2.15.3/node_modules/consola/dist/consola.js
var require_consola = _chunkBL2PMODFjs.__commonJS.call(void 0, {
  "node_modules/.pnpm/consola@2.15.3/node_modules/consola/dist/consola.js"(exports, module) {
    ...
    var D = u(_chunkBL2PMODFjs.__require.call(void 0, "util"));
    var e = _chunkBL2PMODFjs.__require.call(void 0, "path");
    var t = _chunkBL2PMODFjs.__require.call(void 0, "fs");
    var r = u(_chunkBL2PMODFjs.__require.call(void 0, "os"));
    var n = u(_chunkBL2PMODFjs.__require.call(void 0, "tty"));
    function s(u2, D2) {
    ...
    var Gu = "undefined" != typeof __non_webpack_require__ ? __non_webpack_require__ : _chunkBL2PMODFjs.__require;
    var zu = class {
      constructor(u2) {
        if (u2 && u2.log)
          this.logger = u2;
  ...
  return {
    ...
    setup(build2) {
      ...
      const getPostcssConfig = async () => {
        const loadConfig = _chunkBL2PMODFjs.__require.call(void 0, "postcss-load-config");
        if (configCache) {
          return configCache;
        }
        try {
      ...
      build2.onLoad({ filter: /\.css$/ }, async (args) => {
        ...
        if (plugins && plugins.length > 0) {
          const postcss = _chunkBL2PMODFjs.getPostcss.call(void 0, );
          if (!postcss) {
            return {
              errors: [
                {
          ...
          const result = _optionalChain([postcss, 'optionalAccess', _2 => _2.default, 'call', _3 => _3(plugins), 'access', _4 => _4.process, 'call', _5 => _5(contents, { ...options, from: args.path })]);
          contents = result.css;
        }
        if (inject) {
  ...
  return {
    ...
    setup(build2) {
      ...
      build2.onLoad({ filter: /\.svelte$/ }, async (args) => {
        svelte = svelte || _chunkBL2PMODFjs.localRequire.call(void 0, "svelte/compiler");
        sveltePreprocessor = sveltePreprocessor || _chunkBL2PMODFjs.localRequire.call(void 0, "svelte-preprocess");
        if (!svelte) {
          return {
...
// src/esbuild/index.ts
var import_consola = _chunkBL2PMODFjs.__toESM.call(void 0, require_consola());
...
var swcPlugin = ({ logger: logger3 }) => {
  return {
    name: "swc",
    setup(build2) {
      const swc = _chunkBL2PMODFjs.localRequire.call(void 0, "@swc/core");
      if (!swc) {
        logger3.warn(
  ...
  return {
    ...
    setup(build2) {
      build2.onResolve({ filter: /\.node$/, namespace: "file" }, (args) => {
        const resolvedId = _chunkBL2PMODFjs.__require.resolve(args.path, {
...
var getOutputExtensionMap = (options, format, pkgType) => {
  const outExtension = options.outExtension || _chunkBL2PMODFjs.defaultOutExtension;
  const defaultExtension = _chunkBL2PMODFjs.defaultOutExtension.call(void 0, { format, pkgType });
...
var generateExternal = async (external) => {
  ...
  for (const item of external) {
    ...
    const deps = await _chunkX22RQBZHjs.getProductionDeps.call(void 0, pkgPath);
    result.push(...deps);
  }
  return result;
};
async function runEsbuild(options, {
  ...
  const pkg = await _chunkX22RQBZHjs.loadPkg.call(void 0, process.cwd());
  const deps = await _chunkX22RQBZHjs.getProductionDeps.call(void 0, process.cwd());
  const external = [
  ...
  try {
    result = await _esbuild.build.call(void 0, {
      ...
      plugins: esbuildPlugins.filter(_chunkBL2PMODFjs.truthy),
      define: {
  ...
  if (result && result.warnings && !_chunkX22RQBZHjs.getSilent.call(void 0, )) {
...
var es5 = () => {
  ...
  return {
    ...
    async renderChunk(code, info) {
      ...
      const swc = _chunkBL2PMODFjs.localRequire.call(void 0, "@swc/core");
      if (!swc) {
        throw new (0, _chunkJ7IVU4KGjs.PrettyError)(
...
var sizeReporter = () => {
  return {
    ...
    buildEnd({ writtenFiles }) {
      _chunkX22RQBZHjs.reportSize.call(void 0, 
        this.logger,
        this.format,
...
var import_rollup_plugin_hashbang = _chunkBL2PMODFjs.__toESM.call(void 0, _chunkX22RQBZHjs.require_dist.call(void 0, ));
...
var isInPublicDir = (publicDir, filePath) => {
  if (!publicDir)
    return false;
  const publicPath = _chunkBL2PMODFjs.slash.call(void 0, 
    _path2.default.resolve(publicDir === true ? "public" : publicDir)
  );
  return _chunkBL2PMODFjs.slash.call(void 0, _path2.default.resolve(filePath)).startsWith(`${publicPath}/`);
};
  ...
  return {
    ...
    async renderChunk(code, info) {
      if (minifyOptions !== "terser" || !/\.(cjs|js|mjs)$/.test(info.path))
        return;
      const terser = _chunkBL2PMODFjs.localRequire.call(void 0, "terser");
      if (!terser) {
        throw new (0, _chunkJ7IVU4KGjs.PrettyError)(
...
var logger = _chunkX22RQBZHjs.createLogger.call(void 0, );
...
function getExports(program, fileMapping) {
  ...
  function extractExports(sourceFileName) {
    ...
    sourceFileName = _chunkBL2PMODFjs.toAbsolutePath.call(void 0, sourceFileName, cwd);
...
function emitDtsFiles(program, host) {
  ...
  let writeFile = (fileName, text, writeByteOrderMark, onError, sourceFiles, data) => {
    ...
    if (sourceFileName && !fileName.endsWith(".map")) {
      const cwd = program.getCurrentDirectory();
      fileMapping.set(
        _chunkBL2PMODFjs.toAbsolutePath.call(void 0, sourceFileName, cwd),
        _chunkBL2PMODFjs.toAbsolutePath.call(void 0, fileName, cwd)
      );
    }
...
function emit(compilerOptions, tsconfig) {
  ...
  let declarationDir = _chunkBL2PMODFjs.ensureTempDeclarationDir.call(void 0, );
...
function runTypeScriptCompiler(options) {
  try {
    ...
    _chunkJ7IVU4KGjs.handleError.call(void 0, error);
...
function formatAggregationExports(exports, declarationDirPath) {
  ...
  ).filter(_chunkBL2PMODFjs.truthy);
  if (lines.length === 0) {
    lines.push("export {};");
  }
  return lines.join("\n") + "\n";
...
function formatAggregationExport(declaration, declarationDirPath) {
  let dest = _chunkBL2PMODFjs.trimDtsExtension.call(void 0, 
    "./" + _path2.default.posix.normalize(
      _chunkBL2PMODFjs.slash.call(void 0, _path2.default.relative(declarationDirPath, declaration.destFileName))
    )
  );
  if (declaration.kind === "module") {
    ...
    return [
      ...
      "} from",
      `'${dest}';`
    ].filter(_chunkBL2PMODFjs.truthy).join(" ");
  } else {
    throw new Error("Unknown declaration");
  }
}
function formatDistributionExports(exports, fromFilePath, toFilePath) {
  let importPath = _chunkBL2PMODFjs.trimDtsExtension.call(void 0, 
    _path2.default.posix.relative(
      _path2.default.posix.dirname(_path2.default.posix.normalize(_chunkBL2PMODFjs.slash.call(void 0, fromFilePath))),
      _path2.default.posix.normalize(_chunkBL2PMODFjs.slash.call(void 0, toFilePath))
    )
  );
  if (!importPath.match(/^\.+\//)) {
    importPath = "./" + importPath;
  }
  const lines = exports.map((declaration) => formatDistributionExport(declaration, importPath)).filter(_chunkBL2PMODFjs.truthy);
  if (lines.length === 0) {
    lines.push("export {};");
  }
  return lines.join("\n") + "\n";
...
// src/api-extractor.ts
var logger2 = _chunkX22RQBZHjs.createLogger.call(void 0, );
function rollupDtsFile(inputFilePath, outputFilePath, tsconfigFilePath) {
  ...
  const imported = _chunkBL2PMODFjs.getApiExtractor.call(void 0, );
  if (!imported) {
    throw new Error(
...
async function rollupDtsFiles(options, exports, format) {
  ...
  let pkg = await _chunkX22RQBZHjs.loadPkg.call(void 0, process.cwd());
  let dtsExtension = _chunkBL2PMODFjs.defaultOutExtension.call(void 0, { format, pkgType: pkg.type }).dts;
  ...
  _chunkBL2PMODFjs.writeFileSync.call(void 0, 
    dtsInputFilePath,
  ...
  for (let [out, sourceFileName] of Object.entries(
    ...
    sourceFileName = _chunkBL2PMODFjs.toAbsolutePath.call(void 0, sourceFileName);
...
var normalizeOptions = async (logger3, optionsFromConfigFile, optionsOverride) => {
  ...
  const options = {
    ...
    experimentalDts: _options.experimentalDts ? typeof _options.experimentalDts === "boolean" ? _options.experimentalDts ? { entry: {} } : void 0 : typeof _options.experimentalDts === "string" ? {
      entry: _chunkBL2PMODFjs.toObjectEntry.call(void 0, _options.experimentalDts)
    } : {
      ..._options.experimentalDts,
      entry: _chunkBL2PMODFjs.toObjectEntry.call(void 0, _options.experimentalDts.entry || {})
    } : void 0
  };
  _chunkX22RQBZHjs.setSilent.call(void 0, options.silent);
  const entry = options.entry || options.entryPoints;
  if (!entry || Object.keys(entry).length === 0) {
    throw new (0, _chunkJ7IVU4KGjs.PrettyError)(`No input files, try "tsup <your-file>" instead`);
  }
  if (Array.isArray(entry)) {
    options.entry = await _globby2.default.call(void 0, entry);
    if (!options.entry || options.entry.length === 0) {
      throw new (0, _chunkJ7IVU4KGjs.PrettyError)(`Cannot find ${entry}`);
    } else {
    ...
    Object.keys(entry).forEach((alias) => {
      ...
      if (!_fs2.default.existsSync(filename)) {
        throw new (0, _chunkJ7IVU4KGjs.PrettyError)(`Cannot find ${alias}: ${filename}`);
      }
    });
    options.entry = entry;
  ...
  if (tsconfig) {
    ...
    if (options.experimentalDts) {
      ...
      options.experimentalDts.entry = _chunkBL2PMODFjs.toObjectEntry.call(void 0, 
    ...
    throw new (0, _chunkJ7IVU4KGjs.PrettyError)(`Cannot find tsconfig: ${options.tsconfig}`);
  }
  if (!options.target) {
...
async function build(_options) {
  const config = _options.config === false ? {} : await _chunkX22RQBZHjs.loadTsupConfig.call(void 0, 
    process.cwd(),
  ...
  await Promise.all(
    [...Array.isArray(configData) ? configData : [configData]].map(
      async (item) => {
        const logger3 = _chunkX22RQBZHjs.createLogger.call(void 0, _optionalChain([item, 'optionalAccess', _29 => _29.name]));
        ...
        const mainTasks = async () => {
          if (!_optionalChain([options, 'access', _31 => _31.dts, 'optionalAccess', _32 => _32.only])) {
            ...
            let depsHash = await _chunkX22RQBZHjs.getAllDepsHash.call(void 0, process.cwd());
            ...
            const debouncedBuildAll = _chunkBL2PMODFjs.debouncePromise.call(void 0, 
              () => {
                return buildAll();
              },
              100,
              _chunkJ7IVU4KGjs.handleError
            );
            const buildAll = async () => {
              ...
              if (options.clean) {
                ...
                await _chunkBL2PMODFjs.removeFiles.call(void 0, ["**/*", ...extraPatterns], options.outDir);
            ...
            const startWatcher = async () => {
              ...
              watcher.on("all", async (type, file) => {
                file = _chunkBL2PMODFjs.slash.call(void 0, file);
                ...
                if (options.watch === true) {
                  if (file === "package.json" && !buildDependencies.has(file)) {
                    const currentHash = await _chunkX22RQBZHjs.getAllDepsHash.call(void 0, process.cwd());
