...
var _chunk7G76EW2Rjs = require('./chunk-7G76EW2R.js');
...
var _chunkGQ77QZBOjs = require('./chunk-GQ77QZBO.js');
...
var require_consola = _chunkGQ77QZBOjs.__commonJS.call(void 0, {
  "node_modules/.pnpm/consola@2.15.3/node_modules/consola/dist/consola.js"(exports, module) {
    ...
    var D = u(_chunkGQ77QZBOjs.__require.call(void 0, "util"));
    var e = _chunkGQ77QZBOjs.__require.call(void 0, "path");
    var t = _chunkGQ77QZBOjs.__require.call(void 0, "fs");
    var r = u(_chunkGQ77QZBOjs.__require.call(void 0, "os"));
    var n = u(_chunkGQ77QZBOjs.__require.call(void 0, "tty"));
    function s(u2, D2) {
    ...
    var Gu = "undefined" != typeof __non_webpack_require__ ? __non_webpack_require__ : _chunkGQ77QZBOjs.__require;
    var zu = class {
      constructor(u2) {
        if (u2 && u2.log)
          this.logger = u2;
  ...
  return {
    ...
    setup(build2) {
      ...
      const getPostcssConfig = async () => {
        const loadConfig = _chunkGQ77QZBOjs.__require.call(void 0, "postcss-load-config");
        if (configCache) {
          return configCache;
        }
        try {
      ...
      build2.onLoad({ filter: /\.css$/ }, async (args) => {
        ...
        if (plugins && plugins.length > 0) {
          const postcss = _chunkGQ77QZBOjs.getPostcss.call(void 0, );
          if (!postcss) {
            return {
              errors: [
                {
  ...
  return {
    ...
    setup(build2) {
      ...
      build2.onLoad({ filter: /\.svelte$/ }, async (args) => {
        svelte = svelte || _chunkGQ77QZBOjs.localRequire.call(void 0, "svelte/compiler");
        sveltePreprocessor = sveltePreprocessor || _chunkGQ77QZBOjs.localRequire.call(void 0, "svelte-preprocess");
        if (!svelte) {
          return {
...
// src/esbuild/index.ts
var import_consola = _chunkGQ77QZBOjs.__toESM.call(void 0, require_consola());
...
var swcPlugin = ({ logger: logger3 }) => {
  return {
    name: "swc",
    setup(build2) {
      const swc = _chunkGQ77QZBOjs.localRequire.call(void 0, "@swc/core");
      if (!swc) {
        logger3.warn(
  ...
  return {
    ...
    setup(build2) {
      build2.onResolve({ filter: /\.node$/, namespace: "file" }, (args) => {
        const resolvedId = _chunkGQ77QZBOjs.__require.resolve(args.path, {
...
var getOutputExtensionMap = (options, format, pkgType) => {
  const outExtension = options.outExtension || _chunkGQ77QZBOjs.defaultOutExtension;
  const defaultExtension = _chunkGQ77QZBOjs.defaultOutExtension.call(void 0, { format, pkgType });
...
var swcTarget = () => {
  ...
  return {
    ...
    async renderChunk(code, info) {
      ...
      const swc = _chunkGQ77QZBOjs.localRequire.call(void 0, "@swc/core");
      if (!swc) {
        throw new (0, _chunkUIX4URMVjs.PrettyError)(
...
var sizeReporter = () => {
  return {
    ...
    buildEnd({ writtenFiles }) {
      _chunk7G76EW2Rjs.reportSize.call(void 0, 
        this.logger,
        this.format,
...
var isInPublicDir = (publicDir, filePath) => {
  if (!publicDir)
    return false;
  const publicPath = _chunkGQ77QZBOjs.slash.call(void 0, 
    _path2.default.resolve(publicDir === true ? "public" : publicDir)
  );
  return _chunkGQ77QZBOjs.slash.call(void 0, _path2.default.resolve(filePath)).startsWith(`${publicPath}/`);
};
  ...
  return {
    ...
    async renderChunk(code, info) {
      if (minifyOptions !== "terser" || !/\.(cjs|js|mjs)$/.test(info.path))
        return;
      const terser = _chunkGQ77QZBOjs.localRequire.call(void 0, "terser");
      if (!terser) {
        throw new (0, _chunkUIX4URMVjs.PrettyError)(
...
function formatAggregationExports(exports, declarationDirPath) {
  ...
  ).filter(_chunkGQ77QZBOjs.truthy);
  if (lines.length === 0) {
    lines.push("export {};");
  }
  return lines.join("\n") + "\n";
...
function formatAggregationExport(declaration, declarationDirPath) {
  let dest = _chunkGQ77QZBOjs.trimDtsExtension.call(void 0, 
...
var killProcess = ({ pid, signal }) => new Promise((resolve, reject) => {
  _treekill2.default.call(void 0, pid, signal, (err) => {
    if (err && !isTaskkillCmdProcessNotFoundError(err))
      return reject(err);
    resolve();
  });
});
var normalizeOptions = async (logger3, optionsFromConfigFile, optionsOverride) => {
  ...
  const options = {
    ...
    experimentalDts: _options.experimentalDts ? typeof _options.experimentalDts === "boolean" ? _options.experimentalDts ? { entry: {} } : void 0 : typeof _options.experimentalDts === "string" ? {
      entry: _chunkGQ77QZBOjs.toObjectEntry.call(void 0, _options.experimentalDts)
    } : {
      ..._options.experimentalDts,
      entry: _chunkGQ77QZBOjs.toObjectEntry.call(void 0, _options.experimentalDts.entry || {})
    } : void 0
  };
  _chunk7G76EW2Rjs.setSilent.call(void 0, options.silent);
  const entry = options.entry || options.entryPoints;
  if (!entry || Object.keys(entry).length === 0) {
    throw new (0, _chunkUIX4URMVjs.PrettyError)(`No input files, try "tsup <your-file>" instead`);
  }
  if (Array.isArray(entry)) {
    options.entry = await _globby2.default.call(void 0, entry);
    if (!options.entry || options.entry.length === 0) {
      throw new (0, _chunkUIX4URMVjs.PrettyError)(`Cannot find ${entry}`);
    } else {
    ...
    Object.keys(entry).forEach((alias) => {
      ...
      if (!_fs2.default.existsSync(filename)) {
        throw new (0, _chunkUIX4URMVjs.PrettyError)(`Cannot find ${alias}: ${filename}`);
      }
    });
    options.entry = entry;
  ...
  if (tsconfig) {
    ...
    throw new (0, _chunkUIX4URMVjs.PrettyError)(`Cannot find tsconfig: ${options.tsconfig}`);
  }
  if (!options.target) {
...
async function build(_options) {
  ...
  await Promise.all(
    [...Array.isArray(configData) ? configData : [configData]].map(
      async (item) => {
        const logger3 = _chunk7G76EW2Rjs.createLogger.call(void 0, _optionalChain([item, 'optionalAccess', _31 => _31.name]));
        ...
        const mainTasks = async () => {
          if (!_optionalChain([options, 'access', _33 => _33.dts, 'optionalAccess', _34 => _34.only])) {
            ...
            const debouncedBuildAll = _chunkGQ77QZBOjs.debouncePromise.call(void 0, 
              () => {
                return buildAll();
              },
              100,
              _chunkUIX4URMVjs.handleError
            );
            const buildAll = async () => {
              ...
              if (options.clean) {
                ...
                await _chunkGQ77QZBOjs.removeFiles.call(void 0, ["**/*", ...extraPatterns], options.outDir);
            ...
            const startWatcher = async () => {
              ...
              watcher.on("all", async (type, file) => {
                file = _chunkGQ77QZBOjs.slash.call(void 0, file);
