...
var _chunkMQYDMBB4js = require('./chunk-MQYDMBB4.js');



var _chunkLPVOPEC4js = require('./chunk-LPVOPEC4.js');
...
var _chunkA4EVZC34js = require('./chunk-A4EVZC34.js');

// node_modules/.pnpm/consola@2.15.3/node_modules/consola/dist/consola.js
var require_consola = _chunkA4EVZC34js.__commonJS.call(void 0, {
  "node_modules/.pnpm/consola@2.15.3/node_modules/consola/dist/consola.js"(exports, module) {
    ...
    var D = u(_chunkA4EVZC34js.__require.call(void 0, "util"));
    var e = _chunkA4EVZC34js.__require.call(void 0, "path");
    var t = _chunkA4EVZC34js.__require.call(void 0, "fs");
    var r = u(_chunkA4EVZC34js.__require.call(void 0, "os"));
    var n = u(_chunkA4EVZC34js.__require.call(void 0, "tty"));
    function s(u2, D2) {
    ...
    var Gu = "undefined" != typeof __non_webpack_require__ ? __non_webpack_require__ : _chunkA4EVZC34js.__require;
    var zu = class {
      constructor(u2) {
        if (u2 && u2.log)
          this.logger = u2;
  ...
  return {
    ...
    setup(build2) {
      ...
      const getPostcssConfig = async () => {
        const loadConfig = _chunkA4EVZC34js.__require.call(void 0, "postcss-load-config");
        if (configCache) {
          return configCache;
        }
        try {
      ...
      build2.onLoad({ filter: /\.css$/ }, async (args) => {
        ...
        if (plugins && plugins.length > 0) {
          const postcss = _chunkA4EVZC34js.getPostcss.call(void 0, );
          if (!postcss) {
            return {
              errors: [
                {
  ...
  return {
    ...
    setup(build2) {
      ...
      build2.onLoad({ filter: /\.svelte$/ }, async (args) => {
        svelte = svelte || _chunkA4EVZC34js.localRequire.call(void 0, "svelte/compiler");
        sveltePreprocessor = sveltePreprocessor || _chunkA4EVZC34js.localRequire.call(void 0, "svelte-preprocess");
        if (!svelte) {
          return {
...
// src/esbuild/index.ts
var import_consola = _chunkA4EVZC34js.__toESM.call(void 0, require_consola());
...
var swcPlugin = ({ logger: logger3 }) => {
  return {
    name: "swc",
    setup(build2) {
      const swc = _chunkA4EVZC34js.localRequire.call(void 0, "@swc/core");
      if (!swc) {
        logger3.warn(
  ...
  return {
    ...
    setup(build2) {
      build2.onResolve({ filter: /\.node$/, namespace: "file" }, (args) => {
        const resolvedId = _chunkA4EVZC34js.__require.resolve(args.path, {
...
var getOutputExtensionMap = (options, format, pkgType) => {
  const outExtension = options.outExtension || _chunkA4EVZC34js.defaultOutExtension;
  const defaultExtension = _chunkA4EVZC34js.defaultOutExtension.call(void 0, { format, pkgType });
...
var generateExternal = async (external) => {
  ...
  for (const item of external) {
    ...
    const deps = await _chunkMQYDMBB4js.getProductionDeps.call(void 0, pkgPath);
    result.push(...deps);
  }
  return result;
};
async function runEsbuild(options, {
  ...
  const pkg = await _chunkMQYDMBB4js.loadPkg.call(void 0, process.cwd());
  const deps = await _chunkMQYDMBB4js.getProductionDeps.call(void 0, process.cwd());
  const external = [
  ...
  try {
    result = await _esbuild.build.call(void 0, {
      ...
      plugins: esbuildPlugins.filter(_chunkA4EVZC34js.truthy),
      define: {
  ...
  if (result && result.warnings && !_chunkMQYDMBB4js.getSilent.call(void 0, )) {
...
var es5 = () => {
  ...
  return {
    ...
    async renderChunk(code, info) {
      ...
      const swc = _chunkA4EVZC34js.localRequire.call(void 0, "@swc/core");
      if (!swc) {
        throw new (0, _chunkLPVOPEC4js.PrettyError)(
...
var sizeReporter = () => {
  return {
    ...
    buildEnd({ writtenFiles }) {
      _chunkMQYDMBB4js.reportSize.call(void 0, 
        this.logger,
        this.format,
...
var import_rollup_plugin_hashbang = _chunkA4EVZC34js.__toESM.call(void 0, _chunkMQYDMBB4js.require_dist.call(void 0, ));
...
var isInPublicDir = (publicDir, filePath) => {
  if (!publicDir)
    return false;
  const publicPath = _chunkA4EVZC34js.slash.call(void 0, 
    _path2.default.resolve(publicDir === true ? "public" : publicDir)
  );
  return _chunkA4EVZC34js.slash.call(void 0, _path2.default.resolve(filePath)).startsWith(`${publicPath}/`);
};
  ...
  return {
    ...
    async renderChunk(code, info) {
      if (minifyOptions !== "terser" || !/\.(cjs|js|mjs)$/.test(info.path))
        return;
      const terser = _chunkA4EVZC34js.localRequire.call(void 0, "terser");
      if (!terser) {
        throw new (0, _chunkLPVOPEC4js.PrettyError)(
...
var logger = _chunkMQYDMBB4js.createLogger.call(void 0, );
...
function getExports(program, fileMapping) {
  ...
  function extractExports(sourceFileName) {
    ...
    sourceFileName = _chunkA4EVZC34js.toAbsolutePath.call(void 0, sourceFileName, cwd);
...
function emitDtsFiles(program, host) {
  ...
  let writeFile = (fileName, text, writeByteOrderMark, onError, sourceFiles, data) => {
    ...
    if (sourceFileName && !fileName.endsWith(".map")) {
      const cwd = program.getCurrentDirectory();
      fileMapping.set(
        _chunkA4EVZC34js.toAbsolutePath.call(void 0, sourceFileName, cwd),
        _chunkA4EVZC34js.toAbsolutePath.call(void 0, fileName, cwd)
      );
    }
...
function emit(compilerOptions, tsconfig) {
  ...
  let declarationDir = _chunkA4EVZC34js.ensureTempDeclarationDir.call(void 0, );
...
function runTypeScriptCompiler(options) {
  try {
    ...
    _chunkLPVOPEC4js.handleError.call(void 0, error);
...
function formatAggregationExports(exports, declarationDirPath) {
  ...
  ).filter(_chunkA4EVZC34js.truthy);
  if (lines.length === 0) {
    lines.push("export {};");
  }
  return lines.join("\n") + "\n";
...
function formatAggregationExport(declaration, declarationDirPath) {
  let dest = _chunkA4EVZC34js.trimDtsExtension.call(void 0, 
    "./" + _path2.default.posix.normalize(
      _chunkA4EVZC34js.slash.call(void 0, _path2.default.relative(declarationDirPath, declaration.destFileName))
    )
  );
  if (declaration.kind === "module") {
    ...
    return [
      ...
      "} from",
      `'${dest}';`
    ].filter(_chunkA4EVZC34js.truthy).join(" ");
  } else {
    throw new Error("Unknown declaration");
  }
}
function formatDistributionExports(exports, fromFilePath, toFilePath) {
  let importPath = _chunkA4EVZC34js.trimDtsExtension.call(void 0, 
    _path2.default.posix.relative(
      _path2.default.posix.dirname(_path2.default.posix.normalize(_chunkA4EVZC34js.slash.call(void 0, fromFilePath))),
      _path2.default.posix.normalize(_chunkA4EVZC34js.slash.call(void 0, toFilePath))
    )
  );
  if (!importPath.match(/^\.+\//)) {
    importPath = "./" + importPath;
  }
  const lines = exports.map((declaration) => formatDistributionExport(declaration, importPath)).filter(_chunkA4EVZC34js.truthy);
  if (lines.length === 0) {
    lines.push("export {};");
  }
  return lines.join("\n") + "\n";
...
// src/api-extractor.ts
var logger2 = _chunkMQYDMBB4js.createLogger.call(void 0, );
...
async function rollupDtsFiles(options, exports, format) {
  ...
  let pkg = await _chunkMQYDMBB4js.loadPkg.call(void 0, process.cwd());
  let dtsExtension = _chunkA4EVZC34js.defaultOutExtension.call(void 0, { format, pkgType: pkg.type }).dts;
  ...
  _chunkA4EVZC34js.writeFileSync.call(void 0, 
    dtsInputFilePath,
  ...
  for (let [out, sourceFileName] of Object.entries(
    ...
    sourceFileName = _chunkA4EVZC34js.toAbsolutePath.call(void 0, sourceFileName);
...
var normalizeOptions = async (logger3, optionsFromConfigFile, optionsOverride) => {
  ...
  const options = {
    ...
    experimentalDts: _options.experimentalDts ? typeof _options.experimentalDts === "boolean" ? _options.experimentalDts ? { entry: {} } : void 0 : typeof _options.experimentalDts === "string" ? {
      entry: _chunkA4EVZC34js.toObjectEntry.call(void 0, _options.experimentalDts)
    } : {
      ..._options.experimentalDts,
      entry: _chunkA4EVZC34js.toObjectEntry.call(void 0, _options.experimentalDts.entry || {})
    } : void 0
  };
  _chunkMQYDMBB4js.setSilent.call(void 0, options.silent);
  const entry = options.entry || options.entryPoints;
  if (!entry || Object.keys(entry).length === 0) {
    throw new (0, _chunkLPVOPEC4js.PrettyError)(`No input files, try "tsup <your-file>" instead`);
  }
  if (Array.isArray(entry)) {
    options.entry = await _globby2.default.call(void 0, entry);
    if (!options.entry || options.entry.length === 0) {
      throw new (0, _chunkLPVOPEC4js.PrettyError)(`Cannot find ${entry}`);
    } else {
    ...
    Object.keys(entry).forEach((alias) => {
      ...
      if (!_fs2.default.existsSync(filename)) {
        throw new (0, _chunkLPVOPEC4js.PrettyError)(`Cannot find ${alias}: ${filename}`);
      }
    });
    options.entry = entry;
  ...
  if (tsconfig) {
    ...
    if (options.experimentalDts) {
      ...
      options.experimentalDts.entry = _chunkA4EVZC34js.toObjectEntry.call(void 0, 
    ...
    throw new (0, _chunkLPVOPEC4js.PrettyError)(`Cannot find tsconfig: ${options.tsconfig}`);
  }
  if (!options.target) {
...
async function build(_options) {
  const config = _options.config === false ? {} : await _chunkMQYDMBB4js.loadTsupConfig.call(void 0, 
    process.cwd(),
  ...
  await Promise.all(
    [...Array.isArray(configData) ? configData : [configData]].map(
      async (item) => {
        const logger3 = _chunkMQYDMBB4js.createLogger.call(void 0, _optionalChain([item, 'optionalAccess', _29 => _29.name]));
        ...
        const mainTasks = async () => {
          if (!_optionalChain([options, 'access', _31 => _31.dts, 'optionalAccess', _32 => _32.only])) {
            ...
            let depsHash = await _chunkMQYDMBB4js.getAllDepsHash.call(void 0, process.cwd());
            ...
            const debouncedBuildAll = _chunkA4EVZC34js.debouncePromise.call(void 0, 
              () => {
                return buildAll();
              },
              100,
              _chunkLPVOPEC4js.handleError
            );
            const buildAll = async () => {
              ...
              if (options.clean) {
                ...
                await _chunkA4EVZC34js.removeFiles.call(void 0, ["**/*", ...extraPatterns], options.outDir);
            ...
            const startWatcher = async () => {
              ...
              watcher.on("all", async (type, file) => {
                file = _chunkA4EVZC34js.slash.call(void 0, file);
                ...
                if (options.watch === true) {
                  if (file === "package.json" && !buildDependencies.has(file)) {
                    const currentHash = await _chunkMQYDMBB4js.getAllDepsHash.call(void 0, process.cwd());
