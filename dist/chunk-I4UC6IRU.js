...
var require_flat = _chunkA4EVZC34js.__commonJS.call(void 0, {
...
// src/cli-main.ts
var import_flat = _chunkA4EVZC34js.__toESM.call(void 0, require_flat());
...
async function main(options = {}) {
  ...
  cli.command("[...files]", "Bundle files", {
    ...
    if (!options.entry && files.length > 0) {
      options.entry = files.map(_chunkA4EVZC34js.slash);
    }
    if (flags.format) {
