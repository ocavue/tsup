...
var init_sourcemap_codec_es = _chunkA4EVZC34js.__esm.call(void 0, {
  "node_modules/.pnpm/sourcemap-codec@1.4.8/node_modules/sourcemap-codec/dist/sourcemap-codec.es.js"() {
    "use strict";
    charToInteger = {};
...
_chunkA4EVZC34js.__export.call(void 0, magic_string_es_exports, {
  Bundle: () => Bundle,
  SourceMap: () => SourceMap,
  default: () => MagicString
});
...
var init_magic_string_es = _chunkA4EVZC34js.__esm.call(void 0, {
  "node_modules/.pnpm/magic-string@0.25.9/node_modules/magic-string/dist/magic-string.es.js"() {
    "use strict";
...
var require_dist = _chunkA4EVZC34js.__commonJS.call(void 0, {
  "node_modules/.pnpm/rollup-plugin-hashbang@3.0.0_rollup@3.8.1/node_modules/rollup-plugin-hashbang/dist/index.js"(exports, module) {
    ...
    var import_fs2 = __toESM(_chunkA4EVZC34js.__require.call(void 0, "fs"));
    var import_path2 = __toESM(_chunkA4EVZC34js.__require.call(void 0, "path"));
    var import_magic_string = __toESM((init_magic_string_es(), _chunkA4EVZC34js.__toCommonJS.call(void 0, magic_string_es_exports)));
    var src_default = () => {
...
var loadJson = async (filepath) => {
  try {
    return _chunkA4EVZC34js.jsoncParse.call(void 0, await _fs2.default.promises.readFile(filepath, "utf8"));
  } catch (error) {
...
var colorize = (type, data, onlyImportant = false) => {
  ...
  return _chunkLPVOPEC4js.colorette_exports[color](data);
};
var makeLabel = (name, input, type) => {
  return [
    name && `${_chunkLPVOPEC4js.dim.call(void 0, "[")}${name.toUpperCase()}${_chunkLPVOPEC4js.dim.call(void 0, "]")}`,
...
var reportSize = (logger, format, files) => {
  ...
  for (const name of filenames) {
    logger.success(
      format,
      `${_chunkLPVOPEC4js.bold.call(void 0, padRight(name, maxLength))}${_chunkLPVOPEC4js.green.call(void 0, 
