...
var require_flat = _chunkBL2PMODFjs.__commonJS.call(void 0, {
...
// src/cli-main.ts
var import_flat = _chunkBL2PMODFjs.__toESM.call(void 0, require_flat());
...
async function main(options = {}) {
  ...
  cli.command("[...files]", "Bundle files", {
  ...
  ).option("--dts [entry]", "Generate declaration file").option("--dts-resolve", "Resolve externals types used for d.ts files").option("--dts-only", "Emit declaration files only").option("--experimental-dts [entry]", "Generate declaration file (experimental)").option(
    "--sourcemap [inline]",
    ...
    if (!options.entry && files.length > 0) {
      options.entry = files.map(_chunkBL2PMODFjs.slash);
    }
    if (flags.format) {
